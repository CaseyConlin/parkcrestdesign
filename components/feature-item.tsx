...
export const FeatureItem = (props: {
  ...
  return (
    <section className={`${props.bgColor ? props.bgColor : "bg-white"} `}>
      <div className="grid my-2 max-w-screen-xl px-4 py-8 mx-auto gap-10 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7 p-2">
          <h3 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">
            {props.title}
          </h3>
          ...
          <a
            href={props.siteUrl}
            target="_blank"
            className="inline-flex items-center justify-center px-5 py-3 text-base font-bold text-center text-gray-900 border border-gray-300 rounded-lg bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 hover:no-underline hover:scale-105 duration-500 transition-all"
          >
            Live Site
            <svg
